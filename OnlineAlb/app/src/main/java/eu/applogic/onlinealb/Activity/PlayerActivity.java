...
import eu.applogic.onlinealb.HelperClasses.EventLogger;
import eu.applogic.onlinealb.HelperClasses.TrackSelectionHelper;
...
public class PlayerActivity extends Activity implements OnClickListener, ExoPlayer.EventListener,
  ...
  private HttpDataSource.Factory buildHttpDataSourceFactory(boolean useBandwidthMeter) {
    return ((AppController) getApplication()).buildHttpDataSourceFactory(useBandwidthMeter ? BANDWIDTH_METER : null);
  }
